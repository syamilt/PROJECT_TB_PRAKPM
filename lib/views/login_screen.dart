...
// Impor halaman dan service yang kita butuhkan
...
import 'package:project_tb_sportscope_prakpm/services/api_service.dart'; // Impor ApiService kita

// Konstanta warna dan path aset
          ...
          child: SingleChildScrollView(
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: <Widget>[
                  Image.asset(appLogoPath, height: 150, filterQuality: FilterQuality.high)
                      .animate()
                  ...
                  Text(
                    'Masuk untuk melanjutkan ke SportScope',
                    textAlign: TextAlign.center,
  ...
  Widget _buildSocialImageButton({
    ...
    return GestureDetector(
      onTap: () {
        ...
        // TODO: Nanti kita bisa tambahkan logika login sosial media di sini
      },
      child: Container(
        height: 50,
